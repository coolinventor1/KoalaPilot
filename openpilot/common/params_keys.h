...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ElevenLabsApiKey", {PERSISTENT | DONT_LOG, STRING}},
    {"ElevenLabsVoiceId", {PERSISTENT | DONT_LOG, STRING}},
    ...
    {"KoalaNavDestination", {PERSISTENT | DONT_LOG, JSON}},
    {"KoalaNavEnabled", {PERSISTENT, BOOL, "0"}},
    {"KoalaNavMode", {PERSISTENT, STRING, "shadow"}},
    {"KoalaNavVoicePrompt", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION | DONT_LOG, JSON}},
    ...
    {"MapboxAccessToken", {PERSISTENT | DONT_LOG, STRING}},
